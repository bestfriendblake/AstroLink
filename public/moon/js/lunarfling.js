  ...
  try {
    await fetch('/api/games/lunar-descent/submit', {
      ...
      body: JSON.stringify({
        ...
        fuel_used:          Math.round(100 - (boostsLeft / getUpgradeVal('fuel')) * 100),
        final_velocity:     Math.abs(parseFloat(astronaut.vy.toFixed(4))),
        touchdown_x:        parseFloat(astronaut.x.toFixed(4)),
        touchdown_y:        parseFloat(astronaut.y.toFixed(4)),
